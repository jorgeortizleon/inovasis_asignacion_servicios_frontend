      ...
      <q-card-section class="q-pt-none">
        <q-form ref="form" @submit.prevent="crearServicio" @reset="resetForm" id="create-service-form" class="q-gutter-md">
          <div class="q-gutter-md">
            <div class="row items-center">
              <div class="col">
                ...
                <q-select
                  filled
                  v-model="nuevoServicio.razonSocial"
                  label="Razón Social"
                  hint="Seleccione la razón social"
                  dense
              ...
              <div class="col">
                ...
                <q-select
                  filled
                  v-model="nuevoServicio.userName"
                  label="Usuario"
                  hint="Seleccione el userName"
                  dense
          ...
          <div class="q-gutter-md espacio-borde-izquierda-form">
            <q-input
              filled
              v-model="nuevoServicio.tituloservicio"
              label="Titulo"
          ...
          <div class="q-gutter-md espacio-borde-izquierda-form">
            <q-input
              ...
              label="Descripción"
              hint="Introduzca la descripción del servicio"
              lazy-rules
